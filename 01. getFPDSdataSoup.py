...
queryString = 'NATIONAL_INTEREST_CODE:P20C+LAST_MOD_DATE:[2020/03/30,2020/04/05]'
...
while numRecords == "all" or i < numRecords:
    ...
    for a in range(len(awards)): 
        awardDict = {
                ...
                'awardContractID_transactionNumber' : awards[a].awardContractID.transactionNumber.text if awards[a].transactionNumber.modNumber is not None else "",
                ...
                'referencedIDVID_agencyID' : awards[a].referencedIDVID.modNumber.text if awards[a].referencedIDVID is not None else "",
...
#                need to figure out how to handle NoneType and Keyerror 
#                'inherentlyGovernmentalFunction_description' : awards[a].contractData.inherentlyGovernmentalFunction['description'] if awards[a].inherentlyGovernmentalFunction is not None elif awards[a].inherentlyGovernmentalFunction.get('description') is not None else "",
#                   'kid' if age < 13 else 'teenager' if age < 18 else 'adult'
                ...
                'placeOfPerformance_stateCode_name' : awards[a].placeOfPerformance.stateCode['name'] if awards[a].placeOfPerformance.stateCode is not None else "",
                ...
                'placeOfPerformance_countryCode_name' : awards[a].placeOfPerformance.countryCode['name'] if awards[a].placeOfPerformance.countryCode is not None else "",
                ...
                'placeOfPerformanceZIPCode_county' : awards[a].placeOfPerformance.placeOfPerformanceZIPCode['county'] if awards[a].placeOfPerformance.placeOfPerformanceZIPCode is not None else "",
                'placeOfPerformanceZIPCode-city' : awards[a].placeOfPerformance.placeOfPerformanceZIPCode['city'] if awards[a].placeOfPerformance.placeOfPerformanceZIPCode is not None else "",
                'placeOfPerformanceCongressionalDistrict' : awards[a].placeOfPerformance.placeOfPerformanceCongressionalDistrict if awards[a].placeOfPerformance.placeOfPerformanceCongressionalDistrict is not None else "",
                ...
                'idvTypeOfSetAside' : awards[a].competition.idvTypeOfSetAside['description'] if awards[a].competition.idvTypeOfSetAside is not None else "",
                'typeOfSetAsideSource' : awards[a].competition.typeOfSetAsideSource['description'] if awards[a].competition.typeOfSetAsideSource is not None else "",
                'evaluatedPreference' : awards[a].competition.evaluatedPreference['description'] if awards[a].competition.evaluatedPreference is not None else "",
                'statutoryExceptionToFairOpportunity' : awards[a].competition.statutoryExceptionToFairOpportunity['description'] if awards[a].competition.statutoryExceptionToFairOpportunity is not None else "",
                ...
                'numberOfOffersSource' : awards[a].competition.numberOfOffersSource['description'] if awards[a].competition.numberOfOffersSource is not None else "",
                'commercialItemAcquisitionProcedures' : awards[a].competition.commercialItemAcquisitionProcedures['description'] if awards[a].competition.commercialItemAcquisitionProcedures is not None else "",
                'commercialItemTestProgram' : awards[a].competition.commercialItemTestProgram['description'] if awards[a].competition.commercialItemTestProgram is not None else "",
                'A76Action' : awards[a].competition.A76Action['description'] if awards[a].competition.A76Action is not None else "",
                'fedBizOpps' : awards[a].competition.fedBizOpps['description'] if awards[a].competition.fedBizOpps is not None else "",
                'localAreaSetAside' : awards[a].competition.localAreaSetAside['description'] if awards[a].competition.localAreaSetAside is not None else "",
                ...
                # preferencePrograms
                'subcontractPlan' : awards[a].competition.subcontractPlan['description'] if awards[a].competition.subcontractPlan is not None else "",
                ...
                'productOrServiceCode_productOrServiceType':  awards[a].productOrServiceInformation.productOrServiceCode['productOrServiceType'] if awards[a].productOrServiceInformation.productOrServiceCode is not None else "",
